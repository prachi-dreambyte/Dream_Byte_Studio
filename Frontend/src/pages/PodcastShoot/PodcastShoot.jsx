    ...
    <section className="ContactSection services-sections">
      <div className="container-fluid">
        <div className='ServicePadding SectionFrontSecondSection'>
             <h1 className='FrontHeadSection'>Podcast Shoot</h1>
            <p>At Dream Byte Studio we offer a professional Podcast shoot with a fully equipped podcast setup for quality recording of a podcast. Our podcast Studio is created to make ideas, stories, and conversations come alive. Our team will make sure that you have high-quality podcasts that engage your audience, whether you are an influencer, brand, educator, or business leader. We will provide a smooth-sailing process and our team will assist you with recording, editing, and publishing a professional podcast, whether you’re starting your first podcast or producing content for an established brand.</p>
        </div>
      ...
      <div className="container">
        <div className="row g-4">
          <div className='col-md-9'>
            ...
            <p>Podcast is a way to convey your messages, views and experience in the form of audio and video recording, and with our expert podcast services your voice will always be heard with clarity and create impact. We help small creators and businesses to do a podcast in a professional podcast setup.
                <br/>We offer audio-only sessions or video podcast shoots and our studio is equipped with high-quality audio set-ups, cameras, sound-proofing and lighting to deliver quality output that is of professional standards. Our mission is to provide professional podcast services in order to facilitate your thoughts, experience and message in an efficient manner.</p>
              ...
              <div className="quote-icon">
                ...
                <div className='row'>
                  <div className='col-md-6'>
                    <h6 className="">
                   Custom Podcast Setup</h6>
                 <p>Our podcast studio is designed with premium audio equipment, camera, soundproofing, and lighting to ensure a professional podcast shoot.</p>
                  </div>
                   <div className='col-md-6'>
                    <h6 className="">End-to-End Solutions</h6>
                    <p>We offer end-to-end solutions from recording to editing and branding; we handle everything.</p>
                    </div>
                    <div className='col-md-6'>
