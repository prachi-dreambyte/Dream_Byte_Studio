  ...
  return (
    <>
        ...
        <div className='DreamFrontSecondSection'>
          <div className="container">
            <div className='row'>
              ...
              <h1 className='FrontHeadSection animate-on-scroll slide-up'>The Best Production house in India</h1>
        ...
        <div className='DreamFrontSecondSection'>
          <div className="container">
            <div className='row'>
              ...
              <h1 className='FrontHeadSection animate-on-scroll slide-down'>What makes us the best production house in India?</h1>
              <div className='col-md-6 animate-on-scroll slide-left'>
      ...
      <section className='FrontSecondSection services-sections'>
        ...
        <div className='container-fluid'>
          <div className='FrontSecondSection services-sections animate-on-scroll fade-in'>
            <iframe src='https://widgets.sociablekit.com/google-reviews/iframe/25609436' frameBorder='0' width='100%' height='1000'></iframe>
          </div>
        </div>
      </section>
